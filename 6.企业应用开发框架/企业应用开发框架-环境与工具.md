...
#### 4.1 插件安装
 ...
 IDEA支持功能的扩展，通过插件进行安装。FILE-->Settings-->Plugins 

![image-20201021082117045](img/image-20201021082117045.png)
...
docker run -p 3306:3306 --name mysql  -v ~/program/mysql/conf:/etc/mysql  -v ~/program/mysql/logs:/var/log/mysql  -v ~/program/mysql/data:/var/lib/mysql  -e MYSQL_ROOT_PASSWORD=123456  -d mysql:5.7
